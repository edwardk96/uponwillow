export const heroContent = {
  ...
  subhead:
    "Up to 70% of inherited assets leave the original adviser within a year of the client's death. Two products, one continuous service: a secure vault your client builds with you while they're alive, and a bereavement platform that supports their family - and keeps you in the room - during a sensitive time.",
