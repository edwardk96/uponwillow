  ...
  return (
    ...
    >
      ...
      <h2 className="font-serif text-2xl font-medium tracking-[-0.005em] mb-2">
        Your client. Your family. Your relationship.
      </h2>
      <p className="text-3.5 text-secondary leading-[1.8] mb-8 max-w-3xl">
        This is an extension of your service, not a third party stepping in.
        We don&apos;t market to your clients, and we never approach the family
        without you. Every touchpoint, across every generation, runs through
        you.
      </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
        <div className="p-4 bg-card border-[0.5px] border-divider rounded-md">
          ...
          <p className="text-xs text-tertiary leading-[1.8]">
            Support for the family only begins when you say so, and every
            invite goes out under your firm&apos;s name.
          </p>
        </div>
